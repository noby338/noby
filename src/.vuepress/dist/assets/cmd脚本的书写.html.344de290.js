import{_ as i}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as e,c as n,e as s}from"./app.2dbd8b2d.js";const l={},d=s(`<h2 id="bat-脚本" tabindex="-1"><a class="header-anchor" href="#bat-脚本" aria-hidden="true">#</a> bat 脚本</h2><div class="language-bat line-numbers-mode" data-ext="bat"><pre class="language-bat"><code>::Windows 系统命令行默认使用 GBK 编码（编号: 936），如果需要显示中文，编写的脚本可以使用 ANSI 或 GB2312 编码。
